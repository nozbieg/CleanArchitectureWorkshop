...
{
    public class FirstRowTicketsDbContext : DbContext
    {
        public FirstRowTicketsDbContext(DbContextOptions<FirstRowTicketsDbContext> options)
            : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(FirstRowTicketsDbContext).Assembly);
